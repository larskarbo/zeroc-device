...
Messages.quit = "Avslutte?"
Messages.username_prompt = "oppgi din bruker-id"
Messages.enter_password = "oppgi passord"
Messages.enter_import_password = "oppgi ditt import passord"
Messages.incorrect_password = "ugyldig passord"
Messages.repeat_password = "gjenta passord"
Messages.passwords_difffer = "passord samsvarer ikke"
Messages.installation_finished = "Installasjon fullfort"
Messages.cat_dir_exisits = "Katalogen {} finnes; noen av filene der " \
    "kan bli overskrevet."
Messages.cont = "Fortsett?"
Messages.nm_not_supported = "Denne NetworkManager versjonen er ikke " \
    "stottet"
Messages.cert_error = "Fant ikke sertifikat fil, ser ut som en CAT " \
    "feil"
Messages.unknown_version = "Ukjent versjon"
Messages.dbus_error = "DBus forbindelsesproblem, prov med sudo " \
    "tilgang"
Messages.yes = "J"
Messages.no = "N"
Messages.p12_filter = "personlig sertifikat fil (p12 eller pfx)"
Messages.all_filter = "Alle filer"
Messages.p12_title = "personlig sertifikat fil (p12 eller pfx)"
Messages.save_wpa_conf = "NetworkManager konfigurasjon feilet, men vi " \
    "kan generere en wpa_supplicant konfigurasjonsfil om du vil. Advarsel - " \
    "ditt passord vil bli lagret i klartekst i denne filen. "
Messages.save_wpa_confirm = "Skriv fil"
Messages.wrongUsernameFormat = "Feil: Ditt brukernavn må være på " \
    "formen xxx@institusjonsID feks 'john@eksempel.net'!"
Messages.wrong_realm = "Feil: Brukernavn må være på formen " \
    "'xxx@{}'. Vennligst oppgi brukernavn i korrekt format."
Messages.wrong_realm_suffix = "Feil: Brukernavn må være på formen " \
    "'xxx@institutionID' og slutte med '{}'. Vennligst oppgi brukernavn i " \
    "korrekt format."
Messages.user_cert_missing = "personlig sertifikat fil ikke funnet"
Config.instname = "Norges teknisk-naturvitenskapelige universitet - " \
    "NTNU"
Config.profilename = "Eduroam NTNU"
Config.url = " \
    ""https://innsida.ntnu.no/web/guest/wiki/-/wiki/Norsk/Orakeltjenesten"
...
Config.init_info = "Dette installasjonsprogrammet har blitt laget for " \
    "{0}\n\nMer informasjon og kommentarer:\n\nEMAIL: {1}\nWWW: " \
    "{2}\n\nInstallasjonsprogram er laget med software fra GEANT " \
    "prosjektet."
Config.init_confirmation = "Dette installasjonsprogrammet vil kun " \
    "fungere om du er medlem av {0}."
